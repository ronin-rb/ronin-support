      ...
      context "when given the version: keyword argument" do
        ...
        context "and it's 1.3" do
          it "must call OpenSSL::SSL::SSLContext#min_version= and #max_version= with OpenSSL::SSL::TLS1_3_VERSION" do
            ...
            subject.ssl_context(version: 1.3)
          end
        end
      ...
      context "when given the min_version: keyword argument" do
        ...
        context "and it's 1.3" do
          it "must call OpenSSL::SSL::SSLContext#min_version= with OpenSSL::SSL::TLS1_3_VERSION" do
            ...
            subject.ssl_context(min_version: 1.3)
          end
        end
      ...
      context "when given the max_version: keyword argument" do
        ...
        context "and it's 1.3" do
          it "must call OpenSSL::SSL::SSLContext#max_version= with OpenSSL::SSL::TLS1_3_VERSION" do
            ...
            subject.ssl_context(max_version: 1.3)
          end
        end
      ...
      context "integration", :network do
        ...
        context "when given a local host and port" do
          ...
          it "must bind to a specific port and host" do
            ssl_server = subject.ssl_server(port: bind_port, host: bind_host)
            tcp_server = ssl_server.to_io
      ...
      context "integration", :network do
        ...
        context "when given a block" do
          ...
          it "must bind to a specific port and host" do
            ...
            subject.ssl_server_session(port: bind_port, host: bind_host) do |ssl_server|
              tcp_server = ssl_server.to_io
              bound_host = tcp_server.addr[3]
              bound_port = tcp_server.addr[1]
            end
      ...
      context "integration", :network do
        context "when a block is given" do
          ...
          it "must open a SSL server socket, accept a single connection, yield a OpenSSL::SSL::SSLSocket, and then close both sockets" do
            ...
            subject.ssl_accept(port: server_port) do |client|
