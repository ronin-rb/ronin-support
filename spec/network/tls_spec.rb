...
describe Ronin::Support::Network::SSL do
  ...
  describe ".context", network: false do
    ...
    describe "when given the verify: keyword argument" do
      subject { super().context(verify: :peer) }
    ...
    describe "when given the cert_file: keyword argument" do
      subject { super().context(key: key, cert_file: cert_file) }
    ...
    describe "when given the key_file: keyword argument" do
      subject { super().context(key_file: key_file, cert: cert) }
    ...
    describe "when given the ca_bundle: keyword argument" do
      context "when value is a file" do
        ...
        subject { super().context(ca_bundle: ca_bundle) }
