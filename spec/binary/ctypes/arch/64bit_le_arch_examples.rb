...
shared_examples_for "64bit LE Arch examples" do
  ...
  let(:int64)  { Ronin::Support::Binary::CTypes::LittleEndian::INT64  }
  let(:uint64) { Ronin::Support::Binary::CTypes::LittleEndian::UINT64 }
