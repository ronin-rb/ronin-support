...
shared_examples_for "32bit BE Arch examples" do
  ...
  let(:int32)  { Ronin::Support::Binary::CTypes::BigEndian::INT32  }
  let(:uint32) { Ronin::Support::Binary::CTypes::BigEndian::UINT32 }
