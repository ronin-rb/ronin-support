...
describe Ronin::Support::Binary::CTypes::TypeResolver do
  let(:types) { Ronin::Support::Binary::CTypes::Native }
  ...
  describe "#resolve" do
    ...
    context "when given a Union class" do
      it "must return a UnionObjectType" do
        ...
        expect(type).to be_kind_of(Ronin::Support::Binary::CTypes::UnionObjectType)
      end
    ...
    context "when given an Array" do
      ...
      context "and it contains a Symbol and a length" do
        it "must return an ArrayObjectType containing the resolved Type and length" do
          ...
          expect(type).to be_kind_of(Ronin::Support::Binary::CTypes::ArrayObjectType)
      ...
      context "and it contains a Struct class" do
        it "must return an ArrayObjectType containing a StructObjectType and the length" do
          ...
          expect(type).to be_kind_of(Ronin::Support::Binary::CTypes::ArrayObjectType)
          expect(type.type).to be_kind_of(Ronin::Support::Binary::CTypes::StructObjectType)
          expect(type.length).to eq(length)
        end
      ...
      context "and it contains a Union class" do
        it "must return an ArrayObjectType containing a UnionObjectType and the length" do
          ...
          expect(type).to be_kind_of(Ronin::Support::Binary::CTypes::ArrayObjectType)
          expect(type.type).to be_kind_of(Ronin::Support::Binary::CTypes::UnionObjectType)
          expect(type.length).to eq(length)
        end
    ...
    context "when given another type of Object" do
      ...
      it do
        expect {
          subject.resolve(object)
        }.to raise_error(ArgumentError,"type type_signature must be a Symbol, Array, Range, #{Ronin::Support::Binary::Struct}, #{Ronin::Support::Binary::Union}, or a #{Ronin::Support::Binary::CTypes::Type} object: #{object.inspect}")
      end
    end
  end
end
