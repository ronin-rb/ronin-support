require 'spec_helper'
require 'ronin/support/binary/ctypes/string_type'

require_relative 'type_examples'

describe Ronin::Support::Binary::CTypes::StringType do
  it do
    expect(described_class).to be < Ronin::Support::Binary::CTypes::Type
  end
