...
class String
  ...
  #
  # Determins if the String is an MD5 checksum.
  #
  # @return [Boolean]
  #   Specifies whether the String is an MD5 checksum.
  #
  # @api public
  #
  # @since 0.6.0
  #
  def md5?
    self =~ /\A[0-9a-fA-F]{32}\z/
  end

  #
  # Determins if the String is an SHA1 checksum.
  #
  # @return [Boolean]
  #   Specifies whether the String is an SHA1 checksum.
  #
  # @api public
  #
  # @since 0.6.0
  #
  def sha1?
    self =~ /\A[0-9a-fA-F]{40}\z/
  end

  #
  # Determins if the String is an SHA256 checksum.
  #
  # @return [Boolean]
  #   Specifies whether the String is an SHA256 checksum.
  #
  # @api public
  #
  # @since 0.6.0
  #
  def sha2?
    self =~ /\A[0-9a-fA-F]{64}\z/
  end

  alias sha256? sha2?

  #
  # Determins if the String is an SHA512 checksum.
  #
  # @return [Boolean]
  #   Specifies whether the String is an SHA512 checksum.
  #
  # @api public
  #
  # @since 0.6.0
  #
  def sha512?
    self =~ /\A[0-9a-fA-F]{128}\z/
  end

  #
  # Determins if the String is an RMD160 checksum.
  #
  # @return [Boolean]
  #   Specifies whether the String is an RMD160 checksum.
  #
  # @api public
  #
  # @since 0.6.0
