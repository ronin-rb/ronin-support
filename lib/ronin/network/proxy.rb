...
module Ronin
  module Network
    ...
    #
    #     on(:client_data) do |client,server,data|
    #       data.gsub!(/foo/,'bar')
    #     end
    #
    # ### server_data
    ...
    #
    #     on(:server_data) do |client,server,data|
    #       data.gsub!(/foo/,'bar')
    #     end
    #
    # ### data
    #
    # Alias for `client_data` and `server_data`.
    #
    # ## Actions
    #
    ...
    class Proxy
      ...
      #   The data generated by a `client_data` or `server_data` event.
      #
      # @example Registers a callback for `server_data`:
      #   on(:server_data) do |server,client,data|
      #     # ...
      #   end
      #
      # @example Registers a callback for `client_data` and `server_data`:
      #   on(:data) do |server,client,data|
      #     # ...
      #   end
      #
      # @api public
      ...
      def on(event,&block)
        ...
        when :data
          ...
          unless @callbacks.has_key?(event)
            raise(ArgumentError,"unknown proxy event: #{event.inspect}")
          end
